                ...
                <div className="flex items-center justify-between p-6 pb-4 border-b border-white/5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/40">Powered by Gemini 2.0 Flash</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
