...
// ── 8 generated posts removed — Convex is the source of truth ──────
// The DEFAULT_BLOG_POSTS above are emergency fallback only (shown when
// the Convex API is unreachable). Real posts live in the blogPosts table.
